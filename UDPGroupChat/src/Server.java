...
public class Server {
	...
	// synchronized map of clientEndPoints
	protected static final Map<Integer, ClientEndPoint> clientEndPoints = 
			Collections.synchronizedMap(new HashMap<Integer, ClientEndPoint>());
	
	// synchronized map of groups
	protected static final Map<String, Group> groups = 
	...
	public void start() {
		...
		try {
			// create a datagram socket, bind to port port. 
	...
	public static void main(String[] args) {
		...
		System.out.println("Starting server. Connect with netcat (nc -u localhost " + port
